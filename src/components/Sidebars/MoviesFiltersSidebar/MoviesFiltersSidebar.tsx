    ...
    return (
        <>
            ...
            <aside
                ...
                className="absolute top-0 right-0 z-20 bg-context-light dark:bg-dark w-screen sm:w-[518px] h-screen flex flex-col px-6 pt-8 pb-12 overflow-y-auto no-scroll"
            >
                <div className="w-full flex justify-between items-center mb-8">
                    ...
                    <img
                        ...
                        onClick={handleClose}
                        data-testid="filters-sidebar-closer"
                    />
                </div>
